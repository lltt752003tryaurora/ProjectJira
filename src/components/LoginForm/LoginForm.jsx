      ...
      <section className="dark:bg-brown-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <Link
            ...
            rel="noreferrer"
          >
            <i className="fa-solid fa-diagram-project text-white-500 hover:text-slate-400"> Project Jira</i>
          </Link>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8 border-amber-600 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <p className="text-sm font-medium text-white">
                  ...
                  <Link
                    to={"/sign-up"}
                    className="font-medium text-primary-600 hover:underline dark:text-primary-500 hover:text-green-300 duration-100"
                  >
                    Sign up
                  </Link>
                </p>
